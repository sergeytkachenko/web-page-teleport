...
export class PageReconstruction {

	public async packPage(document: Document): Promise<ViewEl[]> {
	...
	public async unpackPage(toElement: Element, elements: ViewEl[]): Promise<void> {
